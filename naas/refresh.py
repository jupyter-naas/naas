...
class Refresh:
    ...
    def help(self):
        ...
        print(
            ".clear_history(histonumber, path) => clear history, history number and path are optionel, if you don't provide them it will erase full history of current file \n"
        )
        print(
